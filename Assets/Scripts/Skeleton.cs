...
public class Skeleton : Enemy
{
    ...
    void AttackSound()
    {
        SoundController.sC.Play(audioSource, SoundController.sC.skeleAttack, 1f);
    }

    void WalkSound()
    {
        SoundController.sC.Play(audioSource, SoundController.sC.skeleWalk, 0.2f);
    }

    void HurtSound()
    {
        SoundController.sC.Play(audioSource, SoundController.sC.skeleHurt, 1f);
    }
    void DeathSound()
    {
        SoundController.sC.Play(audioSource, SoundController.sC.skeleDeath, 0.8f);
    }
}
